...
# It is included here in it's original form (I just copy pasted it here) as
# the package conflicts with dplyr if loaded afterwards (it overwrites dplyr::select)
