...
```{r show_conceptual_new, echo=FALSE, cache=TRUE, fig.cap = "<b>Figure 1.</b> Relationship between Evenness of functions and average level of functions for 4 functions at q = 1,2,3, and 4."}
