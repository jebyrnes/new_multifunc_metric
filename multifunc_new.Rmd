...
In this article we propose an new metric of multifunctionality, based on this aspect of effective number of types (or species for species diversity) were we multifunctionality is calculated as the effective number of functions. However as this only gives us the *number* of functions but not the *level* of functioning, we propose to multiply this effective number of fucntions with the average functioning level - which is simply the traditional average multifunctionality metric. 

Multifunctinoality thus becomes [formula]
