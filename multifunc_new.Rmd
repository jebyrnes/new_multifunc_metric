...
Species diversity for a long time, suffered the same problems that multifunctionality suffers today: There are a sheer uncountable number of metrics to estimate alpha diversity, reaching from the simple count of observed species without regard to their abundance (Richness), wide array of metrics incorporating the relative abundance (Shannon entropy, Simpson index, Raouls quadratic Entropy or Berger-Parker Dominance index to name some of the most commen ones), to metrics based on the historgramms of the abundace distribution (e.g. fishers alpha) [REF Magurran and Mcgill book]. Yet, starting with Mc arthur in 1952, then Hill in 1972 and finlay Lou jost in 2006 a common framework for species diversity has been develloped which encompassed the vast majority of previous metrics. The effective number of species. 
